...
export class ExcelService {
  ...
  createExcelFile(orders: any[], products: any[], excelFileName: string) {
    ...
    orders.forEach(function (order) {
      ...
      rowValues[4] = order.street;
      rowValues[5] = order.streetnumber;
      rowValues[6] = order.colony;
      rowValues[7] = order.telephone;
      rowValues[8] = order.notes;
      rowValues[9] = order.pickup;
      rowValues[10] = order.pickupnotes;
      rowValues[11] = order.price;
